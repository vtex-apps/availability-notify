export default {
  ...
  name: '.vtex-availability-notify-1-x-inputName > .vtex-input > .vtex-input-prefix__group > .vtex-styleguide-9-x-input',
  email: '.vtex-availability-notify-1-x-inputEmail > .vtex-input > .vtex-input-prefix__group > .vtex-styleguide-9-x-input'
}
